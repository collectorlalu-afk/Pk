      ...
      <div className="bg-black min-h-screen text-white flex items-center justify-center p-4 selection:bg-white/30">
        <div className="luxury-border p-12 rounded-[2.5rem] text-center bg-card max-w-xl">
          ...
          <p className="text-muted-foreground text-lg mb-10 leading-relaxed">
            Your journey starts now. Please check your email for the vendor access links and instructions.
          </p>
          <a href="/" className="inline-block w-full bg-white text-black hover:bg-neutral-200 py-4 px-8 rounded-2xl font-bold text-lg transition-all">
            Back to Homepage
          </a>
        </div>
      </div>
